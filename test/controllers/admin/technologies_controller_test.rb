...
class Admin::TechnologiesControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "should create technology" do
    assert_difference('Technology.count') do
      post technologies_url, params: { technology: { body: @technology.body, slug: @technology.slug, title: @technology.title } }
    end
  ...
  test "should update technology" do
    patch technology_url(@technology), params: { technology: { body: @technology.body, slug: @technology.slug, title: @technology.title } }
