...
class Admin::TutorialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post tutorials_url, params: { tutorial: { body: @tutorial.body, published: @tutorial.published, slug: @tutorial.slug, title: @tutorial.title, user_id: @tutorial.user_id } }
    end
  ...
  test "should update tutorial" do
    patch tutorial_url(@tutorial), params: { tutorial: { body: @tutorial.body, published: @tutorial.published, slug: @tutorial.slug, title: @tutorial.title, user_id: @tutorial.user_id } }
